...
const SOUNDS: SoundEntry[] = [
  { file: 'music', name: 'Музыка игры', description: 'Главная музыка — играет в меню и в бою.' },
  ...
  { file: 'zvuk-vzryva', name: 'Взрыв базы', description: 'Взрыв базы на всех уровнях (кроме 6-го).' },
