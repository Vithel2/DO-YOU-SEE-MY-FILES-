...
const NEWS: { version: string; date: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Новая ЗОЛОТАЯ банка: +100 монет, светится — не пропусти',
      'Событие «ДОЖДЬ БАНОК»: каждые 50 секунд с неба сыпется куча банок',
      'ВНЕЗАПНАЯ СМЕРТЬ: через 2.5 минуты урон по будкам удваивается',
    ],
  },
  {
    version: 'Beta 1.3',
    date: 'Ранее',
    items: [
      'НОВЫЙ РЕЖИМ PVP: СРАЖЕНИЯ! Сражайся с живыми игроками 1 на 1',
      'Эло-рейтинг: побеждай и поднимайся, проигрывай — теряй очки',
      'Поиск соперника с похожим эло — всё честно',
      'Комнаты: создай приватную с кодом для друга или публичную для всех',
      'История матчей: все твои победы и поражения с ±эло',
      'Звания по эло: от Лунтика до СУПЕР АРСЕНИЯ',
    ],
  },
  {
    version: 'Beta 1.22',
